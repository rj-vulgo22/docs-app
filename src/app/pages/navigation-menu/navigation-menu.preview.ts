			...
			<ul hlmNavigationMenuList class="flex-wrap">
				<li hlmNavigationMenuItem>
					...
					<hlm-navigation-menu-content *hlmNavigationMenuPortal>
						<ul class="w-96">
							<li>
								<a hlmNavigationMenuLink routerLink="/docs/introduction">
							...
							<li>
								<a hlmNavigationMenuLink routerLink="/docs/installation">
									<div class="flex flex-col gap-1 text-sm">
							...
							<li>
								<a hlmNavigationMenuLink routerLink="/docs/typography">
									<div class="flex flex-col gap-1 text-sm">
				...
				<li hlmNavigationMenuItem>
					<a hlmNavigationMenuLink routerLink="/docs/introduction">Docs</a>
				</li>
			</ul>
		</nav>
	`,
