...
@Component({
	...
	template: `
		<hlm-accordion type="single" collapsible>
			<hlm-accordion-item value="account">
				<hlm-accordion-trigger>Can I access my account history?</hlm-accordion-trigger>
				<hlm-accordion-content>
					Yes, you can view your complete account history including all transactions, plan changes, and support
					tickets in the Account History section of your dashboard.
				</hlm-accordion-content>
			</hlm-accordion-item>
			<hlm-accordion-item value="premium" disabled>
			...
			<hlm-accordion-item value="email">
