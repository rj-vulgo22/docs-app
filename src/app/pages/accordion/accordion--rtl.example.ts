...
export class AccordionRtl {
	...
	private readonly _translations: Translations = {
		en: {
			...
			values: {
				...
				answer1:
					"Click on 'Forgot Password' on the login page, enter your email address, and we'll send you a link to reset your password. The link expires within 24 hours.",
	...
	protected readonly _items = [
		{ value: 'item-1', questionKey: 'question1' as const, answerKey: 'answer1' as const },
		{ value: 'item-2', questionKey: 'question2' as const, answerKey: 'answer2' as const },
		{ value: 'item-3', questionKey: 'question3' as const, answerKey: 'answer3' as const },
	];
