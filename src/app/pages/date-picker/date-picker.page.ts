...
import { DatePickerFormRangeExample } from './date-picker--form-range.example';
		...
		<section spartanMainSection>
			...
			<spartan-install-tabs primitive="date-picker">
				<p class="${hlmP} mb-6">
					...
					<a routerLink="/docs/popover" hlmBtn variant="link" class="${link}">Popover</a>
					and the
					<a routerLink="/docs/calendar" hlmBtn variant="link" class="${link}">Calendar</a>
					components.
				</p>
