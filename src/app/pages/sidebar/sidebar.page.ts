...
export const routeData = {
	data: { breadcrumb: 'sidebar', api: 'sidebar' },
...
@Component({
	...
	template: `
		<section spartanMainSection class="space-y-4">
			...
			<div
				class="border-border bg-secondary/50 flex items-center justify-center rounded border p-6 dark:hidden"
			>
				<span class="text-muted-foreground text-sm">[ Sidebar Structure Diagram ]</span>
			</div>

			<div
				class="border-border bg-secondary/50 flex items-center justify-center rounded border p-6 not-dark:hidden"
			>
				<span class="text-muted-foreground text-sm">[ Sidebar Structure Diagram ]</span>
			</div>
			...
			<div
				class="border-border bg-secondary/50 flex items-center justify-center rounded border p-6 dark:hidden"
			>
				<span class="text-muted-foreground text-sm">[ Sidebar Menu Structure Diagram ]</span>
			</div>
